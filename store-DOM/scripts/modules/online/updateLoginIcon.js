...
/>`;
const loggedOutHTML = `<i class="fa-regular fa-user"></i>`;
...
const loginIconSelector = loginSelector.querySelector("a");
const cartSelector = document.getElementById("cart-icon");

export default function updateLoginIcon(onlineStatus) {
  loginIconSelector.innerHTML = onlineStatus ? loggedInHTML : loggedOutHTML;
  cartSelector.innerHTML = onlineStatus ? cartHTML : "";
}
